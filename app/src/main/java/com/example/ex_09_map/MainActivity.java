...
public class MainActivity extends AppCompatActivity  implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlaces.add(new MyPlace("우리집",37.388197399999655, 126.93077169999947, Color.YELLOW));
        mPlaces.add(new MyPlace("강남역",37.497951699999575, 127.02343460000012, Color.BLUE));
